...
def enviar_email():
    corpo_email = """
    <p> Mano, vou tentar mandar a mensagem por aqui um codigo gigante, vamo ve se vai, é uma função de baskara</p>
    <p>def valores():
    ...
    msg['To'] = 'leuzeraxd@gmail.com'
    password = 'fptzyamhqguuizmz'
